  ...
  return (
    <section id="about" className="py-12 px-8 ">
      ...
      <motion.h1
        ...
        viewport={{ once: true }}
      >
        <FaInfoCircle className="inline-block mr-2 text-2xl text-green-600" />
        About Me
      </motion.h1>
      ...
      >
        ...
        <div className="lg:w-1/2 w-full text-center lg:text-left px-4 sm:px-8">
          {/* Description Section */}
          <motion.h2 className="text-2xl font-semibold text-green-600 mb-4">Professional Summary</motion.h2>
          ...
          {/* Education Section */}
          <motion.h3 className="text-2xl font-semibold mb-4 flex items-center gap-2 text-green-700">
